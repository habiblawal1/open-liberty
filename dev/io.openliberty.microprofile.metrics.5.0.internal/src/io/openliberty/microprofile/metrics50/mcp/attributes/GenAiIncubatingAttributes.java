...
public final class GenAiIncubatingAttributes {
    ...
    public static final String GEN_AI_AGENT_VERSION = "gen_ai.agent.version";
    ...
    /**
     * The unique identifier for a conversation (session, thread), used to store and
     * correlate messages within this conversation.
     */
     ...
     *
     * <p>
     * Data sources are used by AI agents and RAG applications to store grounding
     * data. A data source may be an external database, object store, document
     * collection, website, or any other storage system used by the GenAI agent or
     * application. The {@code gen_ai.data_source.id} SHOULD match the identifier
     * used by the GenAI system rather than a name specific to the external storage,
     * such as a database or object store. Semantic conventions referencing {@code
     * gen_ai.data_source.id} MAY also leverage additional attributes, such as
     * {@code db.*}, to further identify and describe the data source.
     */
    public static final String GEN_AI_DATA_SOURCE_ID = "gen_ai.data_source.id";
     ...
     *
     * <p>
     * This attribute provides a human-readable interpretation of the evaluation
     * score produced by an evaluator. For example, a score value of 1 could mean
     * "relevant" in one evaluation system and "not relevant" in another, depending
     * on the scoring range and evaluator. The label SHOULD have low cardinality.
     ...
     */
    @Deprecated
    public static final String GEN_AI_OPENAI_REQUEST_RESPONSE_FORMAT = "gen_ai.openai.request.response_format";
     ...
     */
    @Deprecated
    public static final String GEN_AI_OPENAI_REQUEST_SEED = "gen_ai.openai.request.seed";
     ...
     */
    @Deprecated
    public static final String GEN_AI_OPENAI_REQUEST_SERVICE_TIER = "gen_ai.openai.request.service_tier";
     ...
     */
    @Deprecated
    public static final String GEN_AI_OPENAI_RESPONSE_SERVICE_TIER = "gen_ai.openai.response.service_tier";
     ...
     */
    @Deprecated
    public static final String GEN_AI_OPENAI_RESPONSE_SYSTEM_FINGERPRINT = "gen_ai.openai.response.system_fingerprint";
     ...
     *
     * <p>
     * If one of the predefined values applies, but specific system uses a different
     * name it's RECOMMENDED to document it in the semantic conventions for specific
     * GenAI system and use system-specific name in the instrumentation. If a
     ...
     *
     * <p>
     * This attribute SHOULD be used when the client requests output of a specific
     * type. The model may return zero or more outputs of this type. This attribute
     * specifies the output modality and not the actual output format. For example,
     * if an image is requested, the actual output could be a URL pointing to an
     * image file. Additional output format details may be recorded in the future in
     * the {@code gen_ai.output.{type}.*} attributes.
     */
     ...
     *
     * <p>
     * The attribute SHOULD be set based on the instrumentation's best knowledge and
     * may differ from the actual model provider.
     *
     * <p>
     ...
     *
     * <p>
     * The {@code gen_ai.request.model}, {@code gen_ai.response.model}, and
     * {@code server.address} attributes may help identify the actual system in use.
     *
     * <p>
     * The {@code gen_ai.provider.name} attribute acts as a discriminator that
     * identifies the GenAI telemetry format flavor specific to that provider within
     * GenAI semantic conventions. It SHOULD be set consistently with
     * provider-specific attributes and signals. For example, GenAI spans, metrics,
     * and events related to AWS Bedrock should have the
     * {@code gen_ai.provider.name} set to {@code aws.bedrock} and include
     * applicable {@code aws.bedrock.*} attributes and are not expected to include
     * {@code openai.*} attributes.
     */
    public static final String GEN_AI_PROVIDER_NAME = "gen_ai.provider.name";

    /** The target number of candidate completions to return. */
    public static final String GEN_AI_REQUEST_CHOICE_COUNT = "gen_ai.request.choice.count";
     ...
     *
     * <p>
     * In some GenAI systems the encoding formats are called embedding types. Also,
     * some GenAI systems only accept a single format per request.
     */
     ...
     * </blockquote>
     */
    public static final String GEN_AI_RETRIEVAL_QUERY_TEXT = "gen_ai.retrieval.query.text";
     ...
     *
     * <p>
     * Extension: A tool executed on the agent-side to directly call external APIs,
     * bridging the gap between the agent and real-world systems. Agent-side
     * operations involve actions that are performed by the agent on the server or
     * within the agent's controlled environment. Function: A tool executed on the
     * client-side, where the agent generates parameters for a predefined function,
     * and the client executes the logic. Client-side operations are actions taken
     * on the user's end or within the client application. Datastore: A tool used by
     * the agent to access and query structured or unstructured external data for
     * retrieval-augmented tasks or knowledge updates.
     */
     ...
     *
     * <p>
     * The value SHOULD be included in {@code gen_ai.usage.input_tokens}.
     */
    public static final String GEN_AI_USAGE_CACHE_CREATION_INPUT_TOKENS = "gen_ai.usage.cache_creation.input_tokens";
     ...
     * The value SHOULD be included in {@code gen_ai.usage.input_tokens}.
     */
    public static final String GEN_AI_USAGE_CACHE_READ_INPUT_TOKENS = "gen_ai.usage.cache_read.input_tokens";
     ...
     * total provided by the provider when available or, depending on the provider
    ...
    public static final class GenAiOperationNameIncubatingValues {
         ...
         * <a href="https://ai.google.dev/api/generate-content">Gemini Generate
         * Content</a>
         */
         ...
         * <a href="https://platform.openai.com/docs/api-reference/completions">OpenAI
         * Completions API (Legacy)</a>
         */
        public static final String TEXT_COMPLETION = "text_completion";

        /**
         * Embeddings operation such as <a href=
         * "https://platform.openai.com/docs/api-reference/embeddings/create">OpenAI
         * Create embeddings API</a>
         */
        public static final String EMBEDDINGS = "embeddings";

        /**
         * Retrieval operation such as <a href=
         * "https://platform.openai.com/docs/api-reference/vector-stores/search">OpenAI
    ...
    public static final class GenAiProviderNameIncubatingValues {
        ...
        /**
         * <a href=
         * "https://azure.microsoft.com/products/ai-services/openai-service/">Azure
         * OpenAI</a>
         */
