...
import io.openliberty.mcp.internal.fat.telemetry.PullExporterAutoConfigurationCustomizerProvider;
import io.openliberty.mcp.internal.fat.utils.McpClient;
import io.opentelemetry.sdk.autoconfigure.spi.AutoConfigurationCustomizerProvider;

@RunWith(FATRunner.class)
public class MetricTest extends FATServletClient {
    ...
    public void testToolCallMetrics() throws Exception {
        ...
        FATServletClient.runTest(server, APP_NAME + "/McpMetricServlet", "testMcpToolMetrics");
    }
